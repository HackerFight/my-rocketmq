...
public class Producer {
   ...
   public static void main(String[] args) throws Exception {
       ...
       for (int i = 0; i < 10; i++) {
           ...
           Message msg = new Message(MQConstant.ORDERED_TOPIC, tags[i % tags.length], "KEY" + i, body.getBytes());

           /**
            * 可以看下方法注释，第三个就是和队列选择器一起工作的
            */
